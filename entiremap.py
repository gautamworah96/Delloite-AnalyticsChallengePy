...
berLats=[25.47,18.27,32.18,25.47]
berLons=[-80.13,-66.4,-64.47,-80.13]

x, y = eq_map(berLons, berLats) # forgot this line
eq_map.plot(x, y, 'D-', markersize=4, linewidth=2, color='y', markerfacecolor='b')
plt.title('Location of all plane crashes',**title_font)
